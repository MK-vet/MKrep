...
[![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/MK-vet/strepsuis-genphennet/blob/main/notebooks/network_analysis.ipynb)
[![Docker](https://img.shields.io/badge/docker-ready-blue.svg)](https://hub.docker.com)

## Overview

Network-Based Integration of Genome–Phenome Data for *Streptococcus suis* and other bacterial genomics data.
...
python -m strepsuis_genphennet.cli --data-dir ./examples/data --output ./results
```
