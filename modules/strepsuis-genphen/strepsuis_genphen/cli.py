#!/usr/bin/env python3
"""
StrepSuis-GenPhen: Interactive Platform for Integrated Genomic–Phenotypic Analysis - Command Line Interface
"""

import argparse
import sys
from pathlib import Path
from .analysis import StrepsuisAnalyzer
...
def main():
    ...
    try:
        ...
        print(f"StrepSuis-GenPhen: Interactive Platform for Integrated Genomic–Phenotypic Analysis")
        print("=" * 60)
