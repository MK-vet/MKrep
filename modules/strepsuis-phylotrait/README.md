...
[![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/MK-vet/strepsuis-phylotrait/blob/main/notebooks/phylo_analysis.ipynb)
[![Docker](https://img.shields.io/badge/docker-ready-blue.svg)](https://hub.docker.com)

## Overview

Integrated Phylogenetic and Binary Trait Analysis for *Streptococcus suis* and other bacterial genomics data.
...
python -m strepsuis_phylotrait.cli --data-dir ./examples/data --output ./results
```
