...
This directory contains example datasets for testing and learning StrepSuis-GenPhen.
...
**What you'll see:**
- Genotype-phenotype associations with tree-aware clustering
...
**What you'll see:**
- Complete genomic-phenotypic analysis with phylogenetic context
...
```bash
# Basic example
strepsuis-genphen --data-dir examples/basic/ --output results_basic/

# Advanced example
strepsuis-genphen --data-dir examples/advanced/ --output results_advanced/
```
