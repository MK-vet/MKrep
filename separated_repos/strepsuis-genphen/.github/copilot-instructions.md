# Copilot Instructions for StrepSuis-GenPhen

Interactive platform for integrated genomic-phenotypic analysis with tree-aware clustering.
...
- **`strepsuis_genphen/`**: Main package source code
...
- **Optional files**: `Virulence.csv`, `MLST.csv`, `Serotype.csv`, `tree.newick`
