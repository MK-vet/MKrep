"""
Command-line interface for StrepSuis-GenPhen
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="StrepSuis-GenPhen: Interactive Platform for Integrated Genomic-Phenotypic Analysis",
    ...
    try:
        ...
        logger.info(f"StrepSuis-GenPhen v{__version__}")
