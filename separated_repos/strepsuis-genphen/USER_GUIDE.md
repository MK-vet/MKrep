# User Guide for StrepSuis-GenPhen
...
StrepSuis-GenPhen is a professional bioinformatics tool for analyzing bacterial genomic data. This guide provides step-by-step instructions for using the tool across three different deployment methods.
...
2. Test the container:
   ```bash
   docker run --rm strepsuis-genphen:latest --help
   ```
...
strepsuis-genphen --data-dir . --output ./results
...
```bash
strepsuis-genphen --data-dir examples/ --output test_output/
```
...
```bash
# Using example data
strepsuis-genphen --data-dir examples/ --output results/
...
for dataset in data_*/; do
  ...
  strepsuis-genphen --data-dir "$dataset" --output "$output"
done
```
...
#### Issue: "ModuleNotFoundError: No module named 'strepsuis_genphen'"

**Solution:** Reinstall the package.

```bash
pip uninstall -y strepsuis_genphen
pip install git+https://github.com/MK-vet/strepsuis-genphen.git
```
...
docker run -v $(pwd)/data:/data strepsuis-genphen:latest --data-dir /data --output /output
```
...
3. Search existing [GitHub Issues](https://github.com/MK-vet/strepsuis-genphen/issues)
...
- **Source Code:** [GitHub Repository](https://github.com/MK-vet/strepsuis-genphen)
- **Issues & Support:** [GitHub Issues](https://github.com/MK-vet/strepsuis-genphen/issues)
...
**Need help?** Open an issue on [GitHub](https://github.com/MK-vet/strepsuis-genphen/issues) or refer to the troubleshooting section above.
