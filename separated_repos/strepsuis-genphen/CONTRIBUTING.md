# Contributing to StrepSuis-GenPhen

Thank you for your interest in contributing to StrepSuis-GenPhen! This document provides guidelines and instructions for contributing.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR-USERNAME/strepsuis-genphen.git
   cd strepsuis-genphen
   ```
3. **Add upstream remote**:
   ```bash
   git remote add upstream https://github.com/MK-vet/strepsuis-genphen.git
   ```
