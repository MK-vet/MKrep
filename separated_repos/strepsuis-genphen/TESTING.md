# Testing Guide for strepsuis-genphen

This document describes how to run tests locally and in CI/CD for the strepsuis-genphen package.
...
```bash
pytest --cov=strepsuis_genphen --cov-report=term-missing
```
...
```python
import pytest
from strepsuis_genphen.analyzer import MDRAnalyzer
