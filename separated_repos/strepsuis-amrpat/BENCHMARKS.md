...
This document provides runtime and memory benchmarks for the StrepSuis-AMRPat module
...
```bash
# Basic timing
time python -c "from strepsuis_amrpat import run_smoke_test; run_smoke_test()"
