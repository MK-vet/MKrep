# Testing Guide for StrepSuis-AMRPat

This document describes how to run tests locally and in CI/CD for the StrepSuis-AMRPat package.
...
```bash
pytest --cov=strepsuis_amrpat --cov-report=term-missing
```
