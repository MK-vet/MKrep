# Contributing to StrepSuis-AMRPat

Thank you for your interest in contributing to StrepSuis-AMRPat! This document provides guidelines and instructions for contributing.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR-USERNAME/strepsuis-amrpat.git
   cd strepsuis-amrpat
   ```
3. **Add upstream remote**:
   ```bash
   git remote add upstream https://github.com/MK-vet/strepsuis-amrpat.git
   ```
