...
class MDRAnalyzer:
    """
    Main analyzer class for Advanced multidrug resistance pattern detection with bootstrap resampling and network analysis.
    """
    ...
    def run(self) -> Dict[str, Any]:
        ...
        self.logger.info(
            ...
            "package is installed with: pip install strepsuis-amrpat"
        )
