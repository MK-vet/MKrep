"""
Command-line interface for StrepSuis-AMRPat
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='StrepSuis-AMRPat: Automated Detection of Antimicrobial Resistance Patterns',
    ...
    try:
        ...
        logger.info(f"StrepSuis-AMRPat v{__version__}")
