...
def test_imports():
    ...
    from strepsuis_phylotrait import Config, PhyloAnalyzer

    assert PhyloAnalyzer is not None
...
def test_analyzer_initialization():
    """Test PhyloAnalyzer initialization."""
    from strepsuis_phylotrait import PhyloAnalyzer

    analyzer = PhyloAnalyzer(data_dir="./data", output_dir="./output")
