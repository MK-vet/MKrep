...
def generate_clean_dataset(n_strains: int = 100, n_features: int = 20) -> pd.DataFrame:
    """
...
def generate_adversarial_dataset() -> pd.DataFrame:
    """
...
def save_datasets_with_metadata(output_dir: Path):
    ...
    clean_df = generate_clean_dataset(n_strains=100, n_features=20)
    ...
    adversarial_df = generate_adversarial_dataset()
    ...
    # Create README
    readme_content = """# Synthetic Data for Mathematical Validation
...
"""
    ...
    print(f"\n✓ Datasets generated successfully in {output_dir}")
