# Testing Guide for strepsuis-amrvirkm

This document describes how to run tests locally and in CI/CD for the strepsuis-amrvirkm package.
...
```python
import pytest
from strepsuis_amrvirkm.analyzer import MDRAnalyzer
