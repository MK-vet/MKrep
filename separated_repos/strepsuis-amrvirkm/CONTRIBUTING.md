# Contributing to StrepSuis-AMRVirKM

Thank you for your interest in contributing to StrepSuis-AMRVirKM! This document provides guidelines and instructions for contributing.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR-USERNAME/strepsuis-amrvirkm.git
   cd strepsuis-amrvirkm
   ```
3. **Add upstream remote**:
   ```bash
   git remote add upstream https://github.com/MK-vet/strepsuis-amrvirkm.git
   ```
