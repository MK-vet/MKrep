# User Guide for StrepSuis-AMRVirKM

K-Modes clustering analysis for antimicrobial resistance and virulence profiles
...
StrepSuis-AMRVirKM is a professional bioinformatics tool for analyzing bacterial genomic data. This guide provides step-by-step instructions for using the tool across three different deployment methods.
...
2. Test the container:
   ```bash
   docker run --rm strepsuis-amrvirkm:latest --help
   ```
...
```bash
strepsuis-amrvirkm --data-dir examples/ --output test_output/
```
...
**File:** `Cluster_Analysis_report.html`
...
**File:** `Cluster_Analysis_Report_<timestamp>.xlsx`
...
├── Cluster_Analysis_Report_20250114_120000.xlsx
└── png_charts/
...
for dataset in data_*/; do
  ...
  strepsuis-amrvirkm --data-dir "$dataset" --output "$output"
done
```
...
#### Issue: "ModuleNotFoundError: No module named 'strepsuis_amrvirkm'"

**Solution:** Reinstall the package.

```bash
pip uninstall -y strepsuis_amrvirkm
pip install git+https://github.com/MK-vet/strepsuis-amrvirkm.git
```
...
docker run -v $(pwd)/data:/data strepsuis-amrvirkm:latest --data-dir /data --output /output
```
...
3. Search existing [GitHub Issues](https://github.com/MK-vet/strepsuis-amrvirkm/issues)
...
- **Source Code:** [GitHub Repository](https://github.com/MK-vet/strepsuis-amrvirkm)
- **Issues & Support:** [GitHub Issues](https://github.com/MK-vet/strepsuis-amrvirkm/issues)
...
**Need help?** Open an issue on [GitHub](https://github.com/MK-vet/strepsuis-amrvirkm/issues) or refer to the troubleshooting section above.
